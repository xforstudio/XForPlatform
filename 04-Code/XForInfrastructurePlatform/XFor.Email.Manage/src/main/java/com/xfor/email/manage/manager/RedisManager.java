...
public class RedisManager {
     ...
     */
    public void removeHashValues(String key, Object... items) {
     ...
     * @return
     */
    public double incrementHashValue(String key, String item, double by) {
     ...
     * @return
     */
    public double decrementHashValue(String key, String item, double by) {
        return redisTemplate.opsForHash().increment(key, item, -by);
    }
     ...
     * @return 成功个数
     */
    public long addSetValues(String key, long time, Object...values) {
        try {
     ...
     * @return
     */
    public boolean addListValue(String key, Object value) {
        try {
     ...
     * @return
     */
    public boolean addListValue(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            if (time > 0) {
                this.setExpire(key, time);
     ...
     * @return
     */
    public boolean addListValues(String key, List<Object> values) {
        try {
     ...
     * @return
     */
    public boolean addListValues(String key, List<Object> values, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, values);
            if (time > 0) {
                this.setExpire(key, time);
     ...
     * @param values 待添加的数据
     */
    public void addBoundListValues(String listKey, RedisExpireEnum expireEnum, Object... values) {
        //绑定操作
     ...
     * @return
     */
    public List<Object> getBoundListValues(String listKey, long start, long end) {
        //绑定操作
        BoundListOperations<String, Object> boundOperations = redisTemplate.boundListOps(listKey);
        //查询数据
        return boundOperations.range(start, end);
    }
     ...
     * @param listKey
     */
    public Object removeBoundListValue(String listKey){
        //绑定操作
        BoundListOperations<String, Object> boundOperations = redisTemplate.boundListOps(listKey);
        return boundOperations.rightPop();
    }
